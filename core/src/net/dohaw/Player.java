...
import net.dohaw.gameobjects.JumpableGameObject;
import net.dohaw.utils.Location;

public class Player extends JumpableGameObject implements InputProcessor {

    private float jumpForce = 1;
    private boolean isJumping = false;

    public Player(Eldridge game, TextureRegion texture, Location location) {
